...
public class MockKube {
    ...
    private final Map<String, KubernetesRoleBinding> pdbRb = db(emptySet(), KubernetesRoleBinding.class, DoneableKubernetesRoleBinding.class);
    private final Map<String, KubernetesClusterRoleBinding> pdbCrb = db(emptySet(), KubernetesClusterRoleBinding.class, DoneableKubernetesClusterRoleBinding.class);
    ...
    public KubernetesClient build() {
        ...
        MixedOperation<KubernetesRoleBinding, KubernetesRoleBindingList, DoneableKubernetesRoleBinding, Resource<KubernetesRoleBinding, DoneableKubernetesRoleBinding>> mockRb = buildRb();
    ...
    private MixedOperation<KubernetesRoleBinding, KubernetesRoleBindingList, DoneableKubernetesRoleBinding, Resource<KubernetesRoleBinding, DoneableKubernetesRoleBinding>> buildRb() {
        return new AbstractMockBuilder<KubernetesRoleBinding, KubernetesRoleBindingList, DoneableKubernetesRoleBinding, Resource<KubernetesRoleBinding, DoneableKubernetesRoleBinding>>(
    ...
    private MixedOperation<KubernetesClusterRoleBinding, KubernetesClusterRoleBindingList, DoneableKubernetesClusterRoleBinding, Resource<KubernetesClusterRoleBinding, DoneableKubernetesClusterRoleBinding>> buildCrb() {
        return new AbstractMockBuilder<KubernetesClusterRoleBinding, KubernetesClusterRoleBindingList, DoneableKubernetesClusterRoleBinding, Resource<KubernetesClusterRoleBinding, DoneableKubernetesClusterRoleBinding>>(
                KubernetesClusterRoleBinding.class, KubernetesClusterRoleBindingList.class, DoneableKubernetesClusterRoleBinding.class, castClass(Resource.class), pdbCrb) {
            @Override
