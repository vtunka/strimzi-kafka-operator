...
import io.strimzi.api.kafka.common.CertSecretSourceBuilder;
import io.strimzi.api.kafka.common.KafkaConnectAuthenticationScramSha512Builder;
import io.strimzi.api.kafka.common.KafkaConnectAuthenticationTlsBuilder;
import io.strimzi.api.kafka.v1alpha1.KafkaConnectS2I;
import io.strimzi.api.kafka.v1alpha1.KafkaConnectS2IBuilder;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationEnv;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationEnvBuilder;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationVolumeSource;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationVolumeSourceBuilder;
...
public class KafkaConnectS2IClusterTest {
    ...
    public void testGenerateDeploymentConfig()   {
        DeploymentConfig dep = kc.generateDeploymentConfig(Collections.emptyMap(), true, null);
    ...
    public void withAffinity() throws IOException {
        resourceTester
            .assertDesiredResource("-DeploymentConfig.yaml", kcc -> kcc.generateDeploymentConfig(new HashMap<String, String>(), true, null).getSpec().getTemplate().getSpec().getAffinity());
    }

    @Test
    public void withTolerations() throws IOException {
        resourceTester
            .assertDesiredResource("-DeploymentConfig.yaml", kcc -> kcc.generateDeploymentConfig(new HashMap<String, String>(), true, null).getSpec().getTemplate().getSpec().getTolerations());
    }
    ...
    public void testImagePullPolicy() {
        ...
        DeploymentConfig dep = kc.generateDeploymentConfig(Collections.EMPTY_MAP, true, ImagePullPolicy.ALWAYS);
