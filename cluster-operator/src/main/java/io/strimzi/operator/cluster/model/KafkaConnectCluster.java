...
import io.strimzi.api.kafka.common.CertAndKeySecretSource;
import io.strimzi.api.kafka.common.CertSecretSource;
import io.strimzi.api.kafka.v1alpha1.KafkaConnect;
import io.strimzi.api.kafka.common.KafkaConnectAuthenticationScramSha512;
import io.strimzi.api.kafka.common.KafkaConnectAuthenticationTls;
import io.strimzi.api.kafka.common.KafkaConnectS2ISpec;
import io.strimzi.api.kafka.common.KafkaConnectSpec;
import io.strimzi.api.kafka.common.PasswordSecretSource;
import io.strimzi.api.kafka.common.connect.ExternalConfiguration;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationEnv;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationEnvVarSource;
import io.strimzi.api.kafka.common.connect.ExternalConfigurationVolumeSource;
import io.strimzi.api.kafka.common.template.KafkaConnectTemplate;
